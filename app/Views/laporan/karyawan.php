            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="mt-0 header-title float-left">Laporan Data Karyawan</h4>
                        <div class="card-header-action float-right">
                            <a href="/laporan/cetakKaryawan" target="_blank" class="btn btn-primary btn-sm">
...
<script>
    $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.data.length > 0) {
                            // Transform data to include row number
                            var tableData = response.data.map(function(row, index) {
                                return {
                                    no: index + 1,
        ...
        $('.btn-primary').click(function(e) {
            ...
            if (from_id && to_id) {
                e.preventDefault();
                window.open('/laporan/cetakKaryawan?from_id=' + from_id + '&to_id=' + to_id, '_blank');
            }
        });
    });
</script>
