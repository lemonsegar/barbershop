            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="mt-0 header-title">Edit Booking</h4>
                    </div>
                    <div class="card-body">
                        <form action="/booking/update/<?= $booking['id_booking'] ?>" method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="hidden" name="id_pelanggan" id="id_pelanggan" value="<?= $booking['id_pelanggan'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="hidden" name="id_paket" id="id_paket" value="<?= $booking['id_paket'] ?>">
                                        <input type="text" class="form-control" id="nama_paket" readonly
                                            value="<?= $nama_paket ?>">
                                        <input type="hidden" id="harga_paket" value="<?= $booking['total_harga'] ?>">
                                        <div class="input-group-append">
                                    ...
                                    <!-- Detail Paket -->
                                    <div id="detail_paket" class="mt-2">
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="card-title" id="detail_nama_paket"><?= $nama_paket ?></h5>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p class="mb-1">Jenis Paket: <span id="detail_jenis_paket"><?= $jenis_paket ?></span></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p class="mb-1">Harga: <span id="detail_harga_paket">Rp <?= number_format($booking['total_harga'], 0, ',', '.') ?></span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<!-- Modal Pelanggan dan Paket sama seperti di create.php -->
